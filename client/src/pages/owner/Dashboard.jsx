...
const Dashboard = () => {
  ...
  const renderMonthlyChart = () => {
    ...
    return (
      <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm w-full">
        ...
        <div className="flex items-end justify-between h-56 sm:h-64 gap-2 px-2 sm:px-4 overflow-x-auto">
          {months.length > 0 ? months.map((month, index) => {
            ...
            return (
              <div key={month} className="flex flex-col items-center group relative flex-shrink-0" style={{ minWidth: 32 }}>
      ...
      <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm w-full">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-6">
          ...
          <div className="flex-1 space-y-2 w-full">
            {analyticsData.mostRentedCars.map((car, index) => (
              <div key={car._id} className="flex items-center gap-3 p-2 rounded hover:bg-gray-50 transition-colors w-full">
                <div
  ...
  return (
    <div className='px-2 sm:px-4 pt-6 sm:pt-8 lg:pt-10 md:px-6 lg:px-10 flex-1 w-full overflow-x-hidden'>
      <Title 
        title="Dashboard" 
